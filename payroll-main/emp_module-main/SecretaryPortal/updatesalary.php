...
<div class="manual_payroll_update">
                ...
                <div class = "deductions">
                    ...
                    <label for="pagibig">Pagibig</label><br/>
                    <input type="number" name="pagibig" id="pagibig" value="<?php echo $rows->pagibig;?>"><br/>
                    <label for="philhealth">Philhealth</label><br/>
                    <input type="number" name="philhealth" id="philhealth" value="<?php echo $rows->philhealth;?>"><br/>
